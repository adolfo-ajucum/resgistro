...
$table1->addCell(3000)->addText("Q ".number_format($al->price,2,".",","));
$total += $al->price;
}

$section1->addText("TOTAL: Q ".number_format($total,2,".",","),array("size"=>18));
...
$section1->addText("");
$section1->addText("");
//$section1->addText("Generado por BookMedik MEDICENTRO SHALON v2.0");
$section1->addText("MEDICENTRO SHALON");
